...
//     $(".slide1").css({ opacity: 1, top: position.top, height: $(this).height() });
// });

// $("#nav .tab").on("mouseover", function () {
//     var position = $(this).position();
//     $(".slide2").css({ opacity: 1, top: position.top, height: $(this).height() }).addClass("squeeze");
// });
...
// $(".slide1").css({ top: current.top, height: currentHeight });
$("#nav .tab").on("click", function () {
    var position = $(this).position();
    var width = $(this).width();
